var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_.134e52d3.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.0fa4d85d.js"
	},
	{
		type: "style",
		href: "/assets/entry-client.2c91dfcb.css"
	}
],
	"/about": [
	{
		type: "script",
		href: "/assets/about.a7285065.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.0fa4d85d.js"
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$5, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : undefined;
    return r;
  }, {});
...
const _tmpl$$1 = ["<main", " class=\"text-center mx-auto text-gray-700 p-4\"><h1 class=\"text-4xl font-bold\">Telegram</h1></main>"];
function Home() {
...
const _tmpl$ = ["<script", " src=\"https://telegram.org/js/telegram-web-app.js\"></script>"];
function Root() {
